...
//        cetStatisticsAnalysisJob.cetScoreStatisticsTop();
    ...
    public ResponseEntity<Map<String, Object>> currentStatistics(
        ...
        return new ResponseEntity<Map<String, Object>>(cetStatisticAnalysisService.currentStatistics(orgId, collegeNumber, professionNumber, classNumber,className, cetType), HttpStatus.OK);
    }
    /**
     * 英语考试当前状况---人数分布---按行政班
     * @param orgId
    ...
    public ResponseEntity<Map<String, Object>> organizationStatistics(
        ...
        return new ResponseEntity<Map<String, Object>>(cetStatisticAnalysisService.organizationStatistics(orgId, collegeNumber, professionNumber, classNumber,className, cetType), HttpStatus.OK);
    }
    /**
     * 查看数据详情---数据列表
     * @param orgId
    ...
    public ResponseEntity<Object> getDetailList(
            ...
            @ApiParam(value = "pageNumber 第几页") @RequestParam(value = "pageNumber", required = false) Integer pageNumber,
            @ApiParam(value = "pageSize 每页数据的数目") @RequestParam(value = "pageSize", required = false) Integer pageSize){
        return new ResponseEntity<Object>(cetStatisticAnalysisService.getDetailList(orgId, collegeNumber, professionNumber, className, cetType, nj, teacherYear, semester, isPass, scoreSeg, pageNumber, pageSize), HttpStatus.OK);
    }



    @GetMapping(value = "/organizationstatistics/avg", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(httpMethod = "GET", value = "英语考试当前状况---均值分布", response = Void.class, notes = "英语考试当前状况---均值分布---按行政班<br><br><b>@author jianwei.wu</b>")
    public ResponseEntity<Map<String, Object>> organizationStatisticsAvg(
        ...
        return new ResponseEntity<Map<String, Object>>(cetStatisticAnalysisService.avg(orgId, collegeNumber, professionNumber, classNumber, className, cetType), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, Object>> cetSingleStatisticsExport(
            @ApiParam(value = "orgId 学校id" , required = true) @RequestParam(value = "orgId", required = true) Long orgId,
            @ApiParam(value = "cetType 成绩类型： (三级;四级;六级;)" , required = true ) @RequestParam(value = "cetType" , required = true) String cetType,
            @ApiParam(value = "teacherYear 学年" , required = true ) @RequestParam(value = "teacherYear" , required = true) String teacherYear,
            @ApiParam(value = "semester 学期 (春;秋;)" , required = true) @RequestParam(value = "semester" , required = true) String semester
    ) {
        return new ResponseEntity<Map<String, Object>>(cetStatisticAnalysisService.cetSingleStatisticsExport(orgId,cetType,teacherYear, semester),HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, Object>> cetCurrentStatisticsExport(
            @ApiParam(value = "orgId 学校id" , required = true) @RequestParam(value = "orgId", required = true) Long orgId,
            @ApiParam(value = "cetType 成绩类型： (三级;四级;六级;)" , required = true ) @RequestParam(value = "cetType" , required = true) String cetType
    ) {
        return new ResponseEntity<Map<String, Object>>(cetStatisticAnalysisService.cetCurrentStatisticsExport(orgId,cetType),HttpStatus.OK);
    }
