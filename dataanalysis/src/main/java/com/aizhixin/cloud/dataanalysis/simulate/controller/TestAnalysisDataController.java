...
public class TestAnalysisDataController {
	...
	public ResponseEntity<Map<String, Object>> addCetStatistics(
		...
		for (int i = 0; i < num; i++) {
			...
			cetScoreStatistics1.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics2.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics3.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics4.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics5.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics6.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics7.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics8.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics9.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics10.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics11.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics12.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics13.setTeacherYear(teacherYear-i);
			...
			cetScoreStatistics14.setTeacherYear(teacherYear-i);
