...
public class TestMonitorDataController {
	...
	public ResponseEntity<TeachingScheduleStatistics> todayCourseNumAdd(
		...
		teachingScheduleStatistics.setStatisticalTime(DateUtil
				.getCurrentTime(DateUtil.FORMAT_SHORT));
		teachingScheduleStatisticsService.save(teachingScheduleStatistics);
		return new ResponseEntity<TeachingScheduleStatistics>(
				teachingScheduleStatistics, HttpStatus.OK);
	}
	...
	public ResponseEntity<TeachingScheduleStatistics> todayCourseNumUpdate(
		...
		TeachingScheduleStatistics teachingScheduleStatistics = teachingScheduleStatisticsService
				.findById(id);
	...
	public ResponseEntity<AbnormalAttendanceStatistics> abnormalAttendanceAdd(
		...
		return new ResponseEntity<AbnormalAttendanceStatistics>(
				abnormalAttendanceStatistics, HttpStatus.OK);
	...
	public ResponseEntity<AbnormalAttendanceStatistics> abnormalAttendanceUpdate(
		...
		AbnormalAttendanceStatistics abnormalAttendanceStatistics = abnormalAttendanceStatisticsService
				.findById(id);
		...
		if (null != abnormalAttendanceStatistics) {
			...
			abnormalAttendanceStatisticsService
					.save(abnormalAttendanceStatistics);
	...
	public ResponseEntity<AbnormalTeachingStatistics> abnormalTeachingAdd(
		...
		return new ResponseEntity<AbnormalTeachingStatistics>(
				abnormalTeachingStatistics, HttpStatus.OK);
	...
	public ResponseEntity<AbnormalTeachingStatistics> abnormalTeachingUpdate(
		...
		AbnormalTeachingStatistics abnormalTeachingStatistics = abnormalTeachingStatisticsService
				.findById(id);
		...
		if (null != abnormalTeachingStatistics) {
			...
			if (null != changeLecturerNum && changeLecturerNum > 0) {
				...
				abnormalTeachingStatistics
						.setChangeLecturerNum(changeLecturerNum);
