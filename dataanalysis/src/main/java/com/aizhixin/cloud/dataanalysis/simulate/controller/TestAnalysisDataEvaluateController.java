...
public class TestAnalysisDataEvaluateController {
    ...
    public ResponseEntity<Map<String, Object>> generateCourseEvaluate(@ApiParam(value = "orgId 机构id") @RequestParam(value = "orgId", required = true) Long orgId,
        ...
        for(int i=0;i<num;i++){
            ...
            courseEvaluate1.setCollegeName("机控学院");
            ...
            courseEvaluate1.setCourseOpenDepartment("机控学院");
            ...
            courseEvaluate2.setCollegeName("机控学院");
            ...
            courseEvaluate2.setCourseOpenDepartment("机控学院");
            ...
            courseEvaluate3.setCollegeName("外语学院");
            ...
            courseEvaluate3.setCourseOpenDepartment("外语学院");
            ...
            courseEvaluate4.setCollegeName("测绘学院");
            ...
            courseEvaluate4.setCourseOpenDepartment("测绘学院");
            ...
            courseEvaluate5.setCollegeName("博文管理学院");
            ...
            courseEvaluate5.setCourseOpenDepartment("博文管理学院");
            ...
            courseEvaluate6.setCollegeName("化生学院");
            ...
            courseEvaluate6.setCourseOpenDepartment("化生学院");
            ...
            courseEvaluate8.setCollegeName("信息学院");
            ...
            courseEvaluate8.setCourseOpenDepartment("信息学院");
    ...
    public ResponseEntity<Map<String, Object>> generateTeacherEvaluate(@ApiParam(value = "orgId 机构id") @RequestParam(value = "orgId", required = true) Long orgId,
        ...
        for(int i=0;i<num;i++){
            for(int j=1;j<3;j++){
                ...
                teacherEvaluate1.setCollegeName("机控学院");
                ...
                teacherEvaluate2.setCollegeName("机控学院");
                ...
                teacherEvaluate3.setCollegeName("外语学院");
                ...
                teacherEvaluate4.setCollegeName("测绘学院");
                ...
                teacherEvaluate5.setCollegeName("博文管理学院");
                ...
                teacherEvaluate6.setCollegeName("化生学院");
                ...
                teacherEvaluate8.setCollegeName("信息学院");
