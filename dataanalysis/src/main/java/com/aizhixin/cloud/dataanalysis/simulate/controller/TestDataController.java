...
public class TestDataController {
	...
	public ResponseEntity<Map<String, Object>> addRegisterData(
		...
		StudentRegister studentRegister = new StudentRegister();
			studentRegister.setClassCode(01 + "");
			studentRegister.setClassName("测试1班");
			studentRegister.setCollegeCode(01 + "");
			...
			studentRegister.setProfessionalCode(01 + "");
			...
			studentRegister.setTeachYear("2017");
