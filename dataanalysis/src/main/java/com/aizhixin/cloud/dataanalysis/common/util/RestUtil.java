...
public class RestUtil {
    ...
    public String getData(String url, Long orgId){
        HttpEntity<Long> entity = new HttpEntity<>(orgId);
        return httpRequest(url,entity,HttpMethod.GET).getBody();
    }

    public String getData(String url,Object obj){
        HttpEntity<Object> entity = new HttpEntity<Object>(obj);
        return httpRequest(url,entity,HttpMethod.GET).getBody();
    }
}
