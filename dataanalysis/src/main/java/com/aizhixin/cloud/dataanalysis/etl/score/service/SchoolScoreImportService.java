...
import com.aizhixin.cloud.dataanalysis.common.util.DBHelper;
...
public class SchoolScoreImportService {
...
//        SimpleDateFormat f4 = new SimpleDateFormat("yyyy/MM/dd");
    ...
    public static void main(String[] args) throws Exception {
        SchoolScoreImportService service = new SchoolScoreImportService ();
        service.readAndWriteStudentScoreDB("F:\\work\\2018\\大数据\\2018-10-16-guili\\db_data\\cjxx.csv");
    }
}
