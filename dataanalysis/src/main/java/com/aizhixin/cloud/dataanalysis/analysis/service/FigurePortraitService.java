...
public class FigurePortraitService {
    ...
    public Map<String, Object> getPersonalFigurePortrait(Long orgId, String jobNumber) {
        ...
        try {
            ...
            //成绩详情
            StringBuilder scoresql = new StringBuilder("SELECT s.KCH as kch,c.COURSE_NAME as cName,s.JSXM as teacher, c.CREDIT as kxf,c.COURSE_TYPE as kclx,s.DJLKSCJ as djlkscj,s.PSCJ as pscj,s.FSLKSCJ as fslksch,s.JD as jd " +
